...
ros2 launch openarmx_teleop_exo websocket_teleoperator.launch.py enable_left_arm:=true enable_right_arm:=false
ros2 launch openarmx_teleop_exo websocket_teleoperator.launch.py enable_vehicle_control:=false
"""
